...
# with command line options: L1TMuonSimulations/Configuration/python/PPD-PhaseIITDRFall17GS-00001-fragment.py --step GEN,SIM --mc --eventcontent FEVTDEBUGHLT --datatier GEN-SIM --conditions auto:phase2_realistic --beamspot HLLHC14TeV --geometry Extended2023D17 --era Phase2_timing --customise SimGeneral/MixingModule/customiseStoredTPConfig.higherPtTP,SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000 --python_filename pset_MinBias_TuneCUETP8M1_14TeV-pythia8.py --fileout file:MinBias.root --no_exec --nThreads 4 -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('L1TMuonSimulations/Configuration/python/PPD-PhaseIITDRFall17GS-00001-fragment.py nevts:100'),
