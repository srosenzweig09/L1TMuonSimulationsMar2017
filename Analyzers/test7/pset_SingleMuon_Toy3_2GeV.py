...
process.generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    PGunParameters = cms.PSet(
        MaxEta = cms.double(1.8587),
        MaxPhi = cms.double(3.141592653589793/4),
        MaxPt = cms.double(2.0),
        MinEta = cms.double(1.8587),
...
if True:
    ...
    process.ntupler.outFileName = 'ntuple_SingleMuon_Toy3_2GeV.root'
    ...
    process.ntuple_step = cms.Path(process.ntupler * process.ttstubntupler)
    process.schedule = cms.Schedule(process.generation_step,process.genfiltersummary_step,process.simulation_step,process.digitisation_step,process.L1simulation_step,process.L1TrackTrigger_step, process.ntuple_step)
