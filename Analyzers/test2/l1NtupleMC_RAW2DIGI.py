...
# with command line options: l1NtupleMC --step RAW2DIGI --mc --eventcontent RAWSIM --nThreads 4 --conditions auto:phase2_realistic --beamspot HLLHC14TeV --geometry Extended2023D11 --era Phase2C2_timing --filein file:dummy.root -n 100 --no_exec
